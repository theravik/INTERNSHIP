...
$sql = "select serv_id, prod_name, prod_cond, descript, serv.mem_id, name, email, mobileno, addres, pincode from info join serv where serv.mem_id = info.mem_id";
$result = $con -> query($sql);
...
$sql = "select install_id, prod_name, install.mem_id, name, email, mobileno, addres, pincode from info join install where install.mem_id = info.mem_id";
$result = $con -> query($sql);
...
$sql = "select reinstall_id, prod_name, reinstall.mem_id, name, email, mobileno, old_addres, new_addres from info join reinstall where reinstall.mem_id = info.mem_id";
$result = $con -> query($sql);
